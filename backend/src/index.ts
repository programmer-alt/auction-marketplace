      ...
      reconnecting = (async () => {
        ...
        while (attempt < maxAttempts) {
          ...
          try {
            ...
            // Корректно закрываем все соединения в пуле через pool.end()
            // pool.end() ждёт завершения активных запросов и закрывает idle
            await pool.end();
            ...
            if (attempt >= maxAttempts) reconnecting = null;
          }
        }
      })();
      await reconnecting;
