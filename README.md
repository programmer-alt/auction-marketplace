...
Проект использует PostgreSQL в качестве основной системы управления базами данных.
...
- **Biome**: Единый инструмент для линтинга, форматирования и организации импортов (быстрая замена ESLint + Prettier).
- **PostCSS**: Инструмент для преобразования CSS с помощью плагинов JavaScript.
- **Knip**: Инструмент для поиска неиспользуемых файлов, зависимостей и экспорта в проектах на JavaScript и TypeScript.
...
Проект использует **Biome** — быстрый инструмент для линтинга, форматирования и организации импортов.

```bash
# Авто-исправления (lint + format + organize imports)
npm run lint:fix
